      ...
      <div className="products mt-5">
        <Card className="card border-0" data-aos="fade-up">
          ...
          <Card.Body>
            ...
            <Card.Text>
           Custom Web Development for small and medium sized businesses. We work with you to establish clear goals and help bring your idea to life.
            </Card.Text>
          </Card.Body>
        </Card>
        ...
        <Card className="card border-0" data-aos="fade-up">
          ...
          <Card.Body>
            ...
            <Card.Text>
            If you’re running an online store. Our eCommerce development services can help you set up the perfect solution with WooCommerce or Shopify.
            </Card.Text>
          </Card.Body>
        </Card>
        ...
        <Card className="card border-0" data-aos="fade-up">
          ...
          <Card.Body>
            ...
            <Card.Text>
            Marketing is the process of reaching people with the messages that will create value for your customers and build a strong brand.
            </Card.Text>
          </Card.Body>
        </Card>
        ...
        <Card className="card border-0" data-aos="fade-up">
          ...
          />
          <Card.Body>
            <Card.Title className="fw-bold">Sales Funnel Development</Card.Title>
            <Card.Text>
        ...
        <Card className="card border-0" data-aos="fade-up">
          ...
          />
          <Card.Body>
            <Card.Title className="fw-bold">Tools And Apps Development</Card.Title>
            <Card.Text>
